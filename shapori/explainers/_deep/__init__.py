...
class Deep(Explainer):
    ...
    def shap_values(self, X, ranked_outputs=None, output_rank_order='max', check_additivity=True, neighbourhood=False, scaling=False, lime=False, bandwidth=30.):
        ...
        array or list
            ...
            were chosen as "top".
        """
        return self.explainer.shap_values(X, ranked_outputs, output_rank_order, check_additivity=check_additivity, neighbourhood=neighbourhood, scaling=scaling, bandwidth=bandwidth, lime=lime)
